            ...
            <div class="col-md-4">
                <div class="card">
                    ...
                    <div class="card-body mt-4 ml-2">
                      ...
                      <p class="card-text text-left"><small><i class="fas fa-envelope"></i> {{$profile->phone}}</small></p>
            ...
            <div class="col-md-8">
                <form class="border px-4 pt-2 pb-3" method="POST" action="{{route('profile-update',$profile->id)}}">
                    ...
                    <div class="form-group">
                      ...
                      <input id="inputTitle" type="text" name="phone" placeholder="Enter phone"  value="{{$profile->phone}}" class="form-control">
                      @error('phone')
                      <span class="text-danger">{{$message}}</span>
                      @enderror
                      </div>
